...
// OAuth2 API.
  final authorizationEndpoint = Uri.parse(
      'https://cmcinfinity-dev-ed.my.salesforce.com/services/oauth2/authorize');
  final tokenEndpoint = Uri.parse(
      'https://cmcinfinity-dev-ed.my.salesforce.com/services/oauth2/token');
...
// with certainty that a client is who it claims to be.
  final identifier =
      '3MVG9YDQS5WtC11rWdcCAUYsljvKVu5IzgImWYMf_7GjORIztH1G_pO8GDxX4P3r6mSw3kZknaQ6W5CBOKAbq';
  final secret =
      'B3E1C3349AAFEB99A98E29A9F7CB3D8F7B56A62B640651F0869F74A09EA2B092';
...
// query parameters.
  final redirectUrl =
      Uri.parse('https://cmcinfinity-dev-ed.my.salesforce.com/oauth2/callback');
  ...
  Future<void> _login() async {
    ...
    final password = 'anhtaimmk@1234'; // SYxVnDtJBIucYIZN7jhbdd7Fr
